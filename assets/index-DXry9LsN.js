 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Kg;function Wx(){return Kg||(Kg=1,(function(o){function t(N,j){var W=N.length;N.push(j);t:for(;0<W;){var xt=W-1>>>1,U=N[xt];if(0<l(U,j))N[xt]=j,N[W]=U,W=xt;else break t}}function i(N){return N.length===0?null:N[0]}function r(N){if(N.length===0)return null;var j=N[0],W=N.pop();if(W!==j){N[0]=W;t:for(var xt=0,U=N.length,$=U>>>1;xt<$;){var vt=2*(xt+1)-1,St=N[vt],Dt=vt+1,Ft=N[Dt];if(0>l(St,W))Dt<U&&0>l(Ft,St)?(N[xt]=Ft,N[Dt]=W,xt=Dt):(N[xt]=St,N[vt]=W,xt=vt);else if(Dt<U&&0>l(Ft,W))N[xt]=Ft,N[Dt]=W,xt=Dt;else break t}}return j}function l(N,j){var W=N.sortIndex-j.sortIndex;return W!==0?W:N.id-j.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;o.unstable_now=function(){return u.now()}}else{var h=Date,d=h.now();o.unstable_now=function(){return h.now()-d}}var m=[],p=[],g=1,v=null,x=3,y=!1,b=!1,R=!1,M=!1,_=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,O=typeof setImmediate<"u"?setImmediate:null;function D(N){for(var j=i(p);j!==null;){if(j.callback===null)r(p);else if(j.startTime<=N)r(p),j.sortIndex=j.expirationTime,t(m,j);else break;j=i(p)}}function B(N){if(R=!1,D(N),!b)if(i(m)!==null)b=!0,H||(H=!0,Z());else{var j=i(p);j!==null&&ot(B,j.startTime-N)}}var H=!1,F=-1,X=5,C=-1;function w(){return M?!0:!(o.unstable_now()-C<X)}function G(){if(M=!1,H){var N=o.unstable_now();C=N;var j=!0;try{t:{b=!1,R&&(R=!1,I(F),F=-1),y=!0;var W=x;try{e:{for(D(N),v=i(m);v!==null&&!(v.expirationTime>N&&w());){var xt=v.callback;if(typeof xt=="function"){v.callback=null,x=v.priorityLevel;var U=xt(v.expirationTime<=N);if(N=o.unstable_now(),typeof U=="function"){v.callback=U,D(N),j=!0;break e}v===i(m)&&r(m),D(N)}else r(m);v=i(m)}if(v!==null)j=!0;else{var $=i(p);$!==null&&ot(B,$.startTime-N),j=!1}}break t}finally{v=null,x=W,y=!1}j=void 0}}finally{j?Z():H=!1}}}var Z;if(typeof O=="function")Z=function(){O(G)};else if(typeof MessageChannel<"u"){var rt=new MessageChannel,ut=rt.port2;rt.port1.onmessage=G,Z=function(){ut.postMessage(null)}}else Z=function(){_(G,0)};function ot(N,j){F=_(function(){N(o.unstable_now())},j)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(N){N.callback=null},o.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):X=0<N?Math.floor(1e3/N):5},o.unstable_getCurrentPriorityLevel=function(){return x},o.unstable_next=function(N){switch(x){case 1:case 2:case 3:var j=3;break;default:j=x}var W=x;x=j;try{return N()}finally{x=W}},o.unstable_requestPaint=function(){M=!0},o.unstable_runWithPriority=function(N,j){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var W=x;x=N;try{return j()}finally{x=W}},o.unstable_scheduleCallback=function(N,j,W){var xt=o.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?xt+W:xt):W=xt,N){case 1:var U=-1;break;case 2:U=250;break;case 5:U=1073741823;break;case 4:U=1e4;break;default:U=5e3}return U=W+U,N={id:g++,callback:j,priorityLevel:N,startTime:W,expirationTime:U,sortIndex:-1},W>xt?(N.sortIndex=W,t(p,N),i(m)===null&&N===i(p)&&(R?(I(F),F=-1):R=!0,ot(B,W-xt))):(N.sortIndex=U,t(m,N),b||y||(b=!0,H||(H=!0,Z()))),N},o.unstable_shouldYield=w,o.unstable_wrapCallback=function(N){var j=x;return function(){var W=x;x=j;try{return N.apply(this,arguments)}finally{x=W}}}})(zf)),zf}var Qg;function qx(){return Qg||(Qg=1,Bf.exports=Wx()),Bf.exports}var If={exports:{}},Rn={};/**
 * @license React
